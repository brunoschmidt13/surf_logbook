...
$stmt_sessoes = $pdo->prepare("
    SELECT s.*, p.modelo as prancha_modelo, p.medidas as prancha_medidas 
    FROM sessoes s 
...
<head>
    ...
    <style>
        ...
        .dashboard-widgets { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-bottom: 40px; }
        .widget-card { background: white; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0; }
        .widget-label { font-size: 12px; text-transform: uppercase; color: #94a3b8; font-weight: 600; letter-spacing: 0.5px; }
        .widget-value { font-size: 32px; font-weight: bold; color: #0f172a; margin-top: 10px; }
        ...
        /* Estilização básica das estrelas no formulário */
    ...
    <div class="main-container">
        ...
        <div class="dashboard-widgets">
            <div class="widget-card">
                <div class="widget-label">Sessions</div>
                <div class="widget-value"><?= $total_sessoes ?></div>
            </div>
            <div class="widget-card">
                <div class="widget-label">Minutes Surfed</div>
                <div class="widget-value"><?= $total_minutos ?></div>
            </div>
            <div class="widget-card">
                ...
                <?php foreach($sessoes as $sessao): ?>
                    <div class="session-item">
                        ...
                        <div class="session-details">
                            ...
                            <strong>Condições:</strong> <?= htmlspecialchars($sessao['condicoes_onda']) ?> <br>
        ...
        <div class="modal-content">
            ...
            <form action="salvar_sessao.php" method="POST" class="form-modal">
                <div class="form-grid">
                    ...
                    <div class="full-width">
                        <label>Condições da Onda</label>
                        <input type="text" name="condicoes_onda" placeholder="Ex: 1m waves @ 10ss">
                    </div>
                    <div class="full-width">
