...
$amigo_nome = $dados_amigo['nome'] ?? 'Buddy';
...
<body>
    <div class="container">
        ...
        <div class="header-battle">
            ...
            <p style="color: #94a3b8; margin: 0;">Comparing your logs with <strong><?= htmlspecialchars($amigo_nome) ?></strong></p>
        </div>

        <div class="compare-grid">
            <div class="battle-card">
                <div class="battle-title">Total Surf Sessions</div>
            ...
            <div class="battle-card">
                <div class="battle-title">Total Water Time</div>
                <div class="versus-row">
            ...
            <div class="battle-card">
                <div class="battle-title">Biggest Wave Conquered</div>
                <div class="versus-row">
